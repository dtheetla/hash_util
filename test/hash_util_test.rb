...
class HashUtilTest < Minitest::Test
  ...
  def test_it_merges_hash2_into_hash1
    ...
    str2 = %{
        { "OccExp": [ 7.00000019e-05, 0.0, -0.023, -0.0250000004, 0.0280000009,
          "abc":{"a":1.0,"b":0.0,"c":[0.0,1.0,2.0]}  ], "PremRV1": [ 8.5, 4.19999981, 5.5,7.80000019 ]}
      }
  ...
  def test_it_extracts_all_numbers_in_a_hash
    str2 = %{
        { "OccExp": [ 0.0250000004, 0.0199999996,10e-5, "abc":{"a":1,"b":0,"c":[0,1,2]}]}
      }
      assert_equal [ 0.0250000004, 0.0199999996,0.0001,1,0,0,1,2], HashUtil.extract_numbers_hash(str2)
  end
end
